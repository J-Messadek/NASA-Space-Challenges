...
def load_embeddings(filename: str = "embeddings.json") -> tuple:
...
def generate_embeddings_from_json(
    json_file: str, api_key: str, output_file: str = "embeddings.json"
):
    """Convert JSON publications to embeddings and save"""
    print(f"Loading publications from {json_file}...")
